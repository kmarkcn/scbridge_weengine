					...
					<td>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;类型&nbsp;&nbsp;
							<select name='good_type'>
								<option value='1'
									<?php if($goods['good_type']=='1') { ?>
										selected='selected'
									<?php } else { ?>
									<?php } ?>"
								>产品1</option>
								<option value='2'
									<?php if($goods['good_type']=='2') { ?>
										selected='selected'
									<?php } else { ?>
									<?php } ?>"
								>产品2</option>
								<option value='3'
									<?php if($goods['good_type']=='3') { ?>
										selected='selected'
									<?php } else { ?>
									<?php } ?>"
								>产品3</option>
								<option value='4'
									<?php if($goods['good_type']=='4') { ?>
										selected='selected'
									<?php } else { ?>
									<?php } ?>"
								>产品4</option>
								<option value='5'
									<?php if($goods['good_type']=='5') { ?>
										selected='selected'
									<?php } else { ?>
									<?php } ?>"
								>产品5</option>
								<option value='6'
									<?php if($goods['good_type']=='6') { ?>
										selected='selected'
									<?php } else { ?>
									<?php } ?>"
								>产品6</option>
						...
						<br/><br/>
						库存&nbsp;&nbsp;<input type="text" name="good_stock" class="" value="<?php echo $goods['good_stock'];?>" autofocus="autofocus" required="required" style='width:60px;'/>
