		...
		<div class="column1 grid-10 alpha omega">
			<div class="form">
				...
				<tr>
					<th>酒店简介</th>
					<td>
						<textarea name="description" class="richtext-clone" id="richtext_content" class="txt grid-5 alpha pin" style="height:120px;width:470px;"><?php echo $hotel['description'];?></textarea>
