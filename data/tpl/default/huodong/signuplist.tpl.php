	...
	<div id="main-column" class="container-12 clearfix member-center">
		<div class="column2 grid-3 alpha omega">
			<div class="area hot-tag">
				<h5>报名情况</h5>
				<ul>
					<li><a href="<?php echo create_url('huodong/display')?>">返回</a></li>
					<li class="current"><a href="<?php echo create_url('index/module', array('do' => 'checksignuplist', 'name' => 'huodong', 'huodong_id' => $huodong_id))?>">查看报名名单</a></li>
				</ul>
			</div>
		</div>
		<div class="column1 grid-10 alpha omega">
			<div class="form manage_list">
				<div class="manage_search">
					...
					<input type="hidden" name="do" value="checksignuplist" />
					<input type="hidden" name="name" value="huodong" />
					<input type="hidden" name="huodong_id" value="<?php echo $huodong_id;?>" />
				...
				<form method="post" action="<?php echo create_url('index/module', array('do' => 'checksignuplist', 'name' => 'huodong', 'huodong_id' => $huodong_id))?>">
					...
					<tr class="list" id="list">
						...
						<td><?php echo date('Y年m月d日', $row['signup_date'])?></td>
