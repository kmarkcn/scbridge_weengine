	...
	<div class="father" style="background-color:black; height:100%;">
        ...
        <div class="content" style="padding:2%;">
        	<div class="content-t">
            	...
            	<a  href="./index.php?act=module&name=scbridge&do=vip_register"><img class="fr" style="width:46%; margin-bottom:2%;" src="./resource/scbridge/img/homepage/homepage_03.png"/></a>
            ...
            <div class="content-c" style="margin-top:2%; margin-bottom:2%;">
                ...
                <a href="tel:18628019101"><img class="fl" style=" width:52.5%;" src="./resource/scbridge/img/homepage/homepage_06.png" /></a>
                <div class="clear"></div>
            </div>
            <div class="content-f">
            	<img style=" width:100%;" src="./resource/scbridge/img/homepage/homepage_08.png" />
            </div>
        </div>
	</div>
<script>
