...
<script type="text/javascript" src="/./resource/scbridgejs/jquery.min.js"></script>
	...
	<div class="ma">
        ...
        <div class="public-head-father">
        	<div class="public-head">
                <a href="hotel-reserve.html"><img class="public-left"  src="./resource/scbridge/img/header-left.png"></a>
                会员中心
            </div>
        </div>
        <!--以上是头部-->
