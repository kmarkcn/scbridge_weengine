		...
		var uploadbutton = KindEditor.uploadbutton({
			...
			afterUpload : function(data) {
				if (data.error === 0) {
					...
					$(uploadbutton.div.parent()[0]).find('#upload-file-view1').html('<div class="upload-view"><input value="'+data.filename+'" type="hidden" name="'+obj.getAttribute('fieldname')+'" id="'+obj.getAttribute('id')+'-value" /><img src="'+url+'" width="100" />&nbsp;&nbsp;<a href="javascript:;" onclick="kindeditor_upload_delete(this, \''+data.filename+'\')">删除</a></div>');
					$(uploadbutton.div.parent()[0]).find('#upload-file-view0').html('<div class="upload-view"><input value="'+data.filename+'" type="hidden" name="'+obj.getAttribute('fieldname')+'" id="'+obj.getAttribute('id')+'-value" /><img src="'+url+'" width="220" height="100"/>&nbsp;&nbsp;<a href="javascript:;" onclick="kindeditor_upload_delete(this, \''+data.filename+'\')">删除</a></div>');
					$(uploadbutton.div.parent()[0]).find('#upload-file-view2').html('<div class="upload-view"><input value="'+data.filename+'" type="hidden" name="'+obj.getAttribute('fieldname')+'" id="'+obj.getAttribute('id')+'-value" /><img src="'+url+'" width="100" />&nbsp;&nbsp;<a href="javascript:;" onclick="kindeditor_upload_delete(this, \''+data.filename+'\')">删除</a></div>');
					$(uploadbutton.div.parent()[0]).find('#upload-file-view3').html('<div class="upload-view"><input value="'+data.filename+'" type="hidden" name="'+obj.getAttribute('fieldname')+'" id="'+obj.getAttribute('id')+'-value" /><img src="'+url+'" width="100" />&nbsp;&nbsp;<a href="javascript:;" onclick="kindeditor_upload_delete(this, \''+data.filename+'\')">删除</a></div>');
